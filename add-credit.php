...
<head>
    ...
    <title>Add credit - Court Booking System</title>
                        ...
                        <div class="card-body">
                            ...
                            <form id="addCredit" enctype="multipart/form-data">
                                ...
                                <div class="alert alert-warning" role="alert">
                                  Your credit will be added to your account after it has been validated by admin (please note that the validation of credit will be between 8am and 8pm and can take a few minutes)
                                  <ul>
                                    <li><b>The court credit is non-refundable</b></li>
                                    <li><b>The court credit can be transferred to another member</b></li> 
                                    <li><b>The court credit can be used in membership renewal</b></li>
                                  </ul>
                                </div>
                                <div class="submit-wrapper text-end">
                                    <butto type="button" class="btn btn-primary btn-lg" id="creditRefillButton">Refill Credit</button>
                                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#creditRefillButton").click(function(){
                ...
                if( credit_amount == 0){
                    alert("Please specify credit amount more than 0");
                ...
                formData.append("payment_type", "refill_credit");
                if (slip_upload) {
